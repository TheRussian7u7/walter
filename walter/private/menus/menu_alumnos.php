...
<nav class="navbar navbar-dark fixed-top" style="background-color: #1E3A8A;" aria-label="Light offcanvas navbar">
  ...
  <div class="offcanvas offcanvas-start" id="userInfoCanvas" aria-labelledby="userInfoCanvasLabel" style="background-color: #1E3A8A; color: white;">
    ...
    <div class="offcanvas-body text-center">
      ...
      <p>Rol: <?php echo htmlspecialchars($rol_elegido); ?></p>

      <hr>
      <p class="badge">Datos de clases</p>
      <p>Cursos inscriptos: <?php echo htmlspecialchars($codigo_usuario); ?></p>
  ...
  <div class="offcanvas offcanvas-end text-white" id="offcanvasNavbarDark" aria-labelledby="offcanvasNavbarDarkLabel" style="background-color: #1E3A8A;">
    <div class="offcanvas-header">
      <h5 class="offcanvas-title">MENU DE ALUMNOS</h5>
      <button type="button" class="btn-close text-reset" data-bs-dismiss="offcanvas"></button>
    </div>
    <div class="offcanvas-body">
      <ul class="navbar-nav">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=CUR"><i class="fas fa-book-open me-2"></i>Cursos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=TAS"><i class="fas fa-tasks me-2"></i>Tareas</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=FOR"><i class="fas fa-comments me-2"></i>Foros</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=CAL"><i class="fas fa-calendar-alt me-2"></i>Calendario</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=MEN"><i class="fas fa-envelope me-2"></i>Mensajes</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=NOT"><i class="fas fa-chart-line me-2"></i>Calificaciones</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=REC"><i class="fas fa-folder-open me-2"></i>Recursos</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="index.php?page=SOP"><i class="fas fa-life-ring me-2"></i>Ayuda</a>
        </li>
