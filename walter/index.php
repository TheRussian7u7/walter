...
<?php require_once "private/menus/menu_normal.php" ?>
    ...
    <div class="row">
      <div class="col-lg-8 offset-lg-2">
        <div class="section-heading">
          ...
          <img src="/walter/private/assets/images/heading-line-dec.png" alt="">
          <p>Ofrecemos planes de suscripción accesibles para garantizar que todos tengan acceso a una educación de calidad. <em>si tu institucion cuenta con nuestra licencia puedes obtener un descuento para la compra de nuestros servicios</em></p>
        </div>
      </div>
      <div class="col-lg-4">
